                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="edit-product.php?product=<?= $product['id']; ?>" class="btn btn-sm btn-warning">
                            ...
                            <!-- <a href="../actions/delete-product.php?product=<?= $product['id']; ?>" class="btn btn-outline-danger">
                                <i class="fa-regular fa-trash-can" data-bs-toggle="modal" data-bs-target="#add-product"></i>
                            </a> -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p class="text-center">Are you sure you want to delete :<span class="fw-bold">"<?= $product['product_name']; ?></span>?</p>                                          
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <a href="../actions/delete-product.php?product=<?= $product['id']; ?>" class="btn btn-danger">Delete</a>                                            
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        ?>
                        <td>
                            <a href="buy-product.php?product=<?= $product['id']; ?>" class="btn btn-success"><i class="fa-solid fa-cash-register"></i></a>
                        </td>
                        <?php
                        }else{
                        ?>
